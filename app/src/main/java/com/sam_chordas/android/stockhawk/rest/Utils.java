...
public class Utils {
        ...
        try {
            ...
            if (jsonObject != null && jsonObject.length() != 0) {
                ...
                if (count == 1) {
                    ...
                    // Check if the object comes empty
                    // This would mean that the stock symbol doesn't exist
    ...
    public static ContentProviderOperation buildBatchOperation(JSONObject jsonObject) {
        ...
        try {
            ...
            // new values displaying in the details screen
            ...
            builder.withValue(QuoteColumns.CAP, jsonObject.getString("MarketCapitalization"));
